                                             ...
                                             double _threshold)
{
    ...
    for (size_t i = 0; i < _descriptor1.data.size(); ++i)
    {
        ...
        for (size_t j = 0; j < _descriptor2.data.size(); ++j)
        {
            ...
            double distance = norm(_descriptor1.data[i], _descriptor2.data[j], NORM_L2);
                                      ...
                                      std::vector<FeatureDescriptor> &_feature_descriptors)
{
    ...
    Ptr<SIFT> sift = SIFT::create(
        SIFT_FEATURE_COUNT, // nfeatures 
        SIFT_LEVEL_COUNT,        // nOctaveLayers
